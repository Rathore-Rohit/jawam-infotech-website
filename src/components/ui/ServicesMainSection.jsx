...
const ServicesMainSection = ({ title, heading, description, points, imgSrc }) => {
  return (
    <>
      <Box
        sx={{ px: { xs: 3, sm: 6, lg: 14 }, py: 12 }}
      >
      ...
      >
        ...
        >
          ...
          <Typography sx={commonTypographyStyles}>
            <span style={{ fontWeight: 500 }}>Expertise</span>: At Jawam
            Infotech, our seasoned professionals bring a wealth of expertise to
            every project, ensuring a deep understanding of your unique
            challenges and delivering solutions that go beyond expectations.
          </Typography>
          <Typography sx={commonTypographyStyles}>
            ...
            not just an application but a strategic asset designed to elevate
            your business.
          </Typography>
          <Typography sx={commonTypographyStyles}>
        ...
        <Box>
          <Grid container spacing={6}>
            <Grid size={{ xs: 12, md: 4 }}>
              <Box sx={boxStyles}>
                <MilitaryTechIcon sx={{ color: theme.palette.text.primary, fontSize: 50 }} />
              ...
              <Box sx={boxStyles}>
                <PsychologyIcon sx={{ color: theme.palette.text.primary, fontSize: 50 }} />
                <Typography component="h4" sx={titleTypographyStyles}>
                  Innovation Hub
                </Typography>
                <Typography sx={descTypographyStyles}>
            ...
            <Grid size={{ xs: 12, md: 4 }}>
              <Box sx={boxStyles}>
                <GroupsIcon sx={{ color: theme.palette.text.primary, fontSize: 50 }} />
                <Typography component="h4" sx={titleTypographyStyles}>
                  Professional Staff
                </Typography>
                <Typography sx={descTypographyStyles}>
                  Empowering Excellence with a Team of Dedicated and
                  Professional Staff.
                </Typography>
              </Box>
              <Box sx={boxStyles}>
                <SupportAgentIcon sx={{ color: theme.palette.text.primary, fontSize: 50 }} />
                <Typography component="h4" sx={titleTypographyStyles}>24/7 Support</Typography>
                <Typography sx={descTypographyStyles}>
